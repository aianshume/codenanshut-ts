...
export function getFiles(category: string): string[] {
...
const getSlugFromFileName = (filePath: string): string => {
...
export async function getAllFilesFrontMatter(category: string) {
...
export async function getChapters(cource: string) {
